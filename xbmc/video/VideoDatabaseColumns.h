...
// collection fields appended to tvshow_view (must match column order in DDL)
constexpr int VIDEODB_DETAILS_TVSHOW_SET_ID             = VIDEODB_DETAILS_TVSHOW_TABLE_LAST_ATTR + 14;
constexpr int VIDEODB_DETAILS_TVSHOW_SET_NAME           = VIDEODB_DETAILS_TVSHOW_TABLE_LAST_ATTR + 15;
constexpr int VIDEODB_DETAILS_TVSHOW_SET_OVERVIEW       = VIDEODB_DETAILS_TVSHOW_TABLE_LAST_ATTR + 16;
